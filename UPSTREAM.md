...
Octoscript does not carry its own copy of the Makepad VM. The language VM,
...
```toml
makepad-script = { git = "https://github.com/OctoSense-org/makepad.git", rev = "712b9f16d1992131bb99c070673faa1929fe75f3" }
```
