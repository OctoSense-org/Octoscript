//! Sealed workflow runtime for mobile and embedded Octoscript hosts.
//!
...
//! selectors to Octoscript source.
...
impl MobileWorkflowBuilder {
    /// Creates a builder with Octoscript's standard execution, pending-tool, and
    ...
    pub fn register_http_endpoint_catalog_tool(
        ...
        policy: ToolPolicy,
        metadata: ToolMetadata,
        catalog: octoscript_capabilities::http_endpoint_catalog::HttpEndpointCatalog,
    ) -> Result<(), ToolRegistrationError> {
        self.runtime
    ...
    where
        R: octoscript_capabilities::http_endpoint_catalog::HttpEndpointSecretResolver + 'static,
    {
        self.runtime
    ...
    pub fn register_http_origin_catalog_tool(
        ...
        policy: ToolPolicy,
        metadata: ToolMetadata,
        catalog: octoscript_capabilities::http_endpoint_catalog::HttpOriginCatalog,
    ) -> Result<(), ToolRegistrationError> {
        self.runtime
...
impl MobileWorkflowRuntime {
    ...
    /// context. It is the smaller of the selected source limit and Octoscript's
    ...
    /// Octoscript's 64-level workflow-data limit.
    ...
    /// accept a schema from Octoscript source or a workflow draft, and it does not
...
mod tests {
    ...
    use octoscript_core::{RuntimeJsonError, DEFAULT_INSTRUCTION_LIMIT};
    ...
    impl TestFile {
        fn new(label: &str, bytes: &[u8]) -> Self {
            ...
            let path = std::env::temp_dir().join(format!(
                "octoscript-mobile-workflow-{label}-{}-{sequence}",
                std::process::id()
            ));
    ...
    fn seals_typed_local_adapters_behind_workflow_policy_approval() {
        ...
        assert_eq!(
            ...
            octoscript_capabilities::ToolDispatch::HostPump
        );
    ...
    fn drives_direct_deferred_modules_behind_workflow_policy_approval() {
        ...
        assert_eq!(
            ...
            octoscript_capabilities::CapabilityModuleMethodMode::Deferred
        );
        assert_eq!(
                ...
                ModuleInterfaceDescriptor {
                    ...
                    input_fields: Some(vec![
                        octoscript_capabilities::CapabilityModuleInputFieldDescriptor {
                            name: "left".to_owned(),
                            field_type:
                                octoscript_capabilities::CapabilityModuleInputFieldType::Integer,
                            required: true,
                    ...
                    output_fields: Some(vec![
                        octoscript_capabilities::CapabilityModuleOutputFieldDescriptor {
                            name: "total".to_owned(),
                            field_type:
                                octoscript_capabilities::CapabilityModuleOutputFieldType::Integer,
                            required: true,
                            description: String::new(),
                            fields: None,
                        },
    ...
    #[cfg(feature = "platform-keyring-secret-resolver")]
    #[test]
    fn seals_native_credential_resolvers_without_workflow_metadata_disclosure() {
        let mut catalog = HttpEndpointCatalog::default();
        catalog
            .insert(
                HttpEndpoint::https(
