...
//! through [`octoscript_storage::AuthenticatedStore`]. It is deliberately separate
...
/// storage backend.
///
/// The journal stores no Octoscript source, tool input/output, secret, capability
...
/// contract; [`octoscript_storage::VolatileMemoryStore`] is suitable only for
